...
<div class="flex">
    <div class="join w-full">
        <input type="text" class="input join-item input-bordered w-24" name="ingredient.{i}.amount" value={ingredient.amount}>
        <input type="text" class="input join-item input-bordered w-full" name="ingredient.{i}.name" value={ingredient.name}>
    </div>
    <button class="btn btn-ghost" type="button" onclick={removeIngredient}>
    ...
    <!--<input type="hidden" name="ingredient.{i}.calories" value={ingredient.calories}>-->
</div>
